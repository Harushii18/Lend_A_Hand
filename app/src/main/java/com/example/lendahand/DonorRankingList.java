...
public class DonorRankingList extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerName.setText(StayLoggedIn.getFName(DonorRankingList.this)+" "+StayLoggedIn.getLName(DonorRankingList.this));

        TextView headerEmail= headerView.findViewById(R.id.headerEmail);
        headerEmail.setText(StayLoggedIn.getEmail(DonorRankingList.this));
        ...
        try {
            ...
            for (int i = 0; i < all.length(); i++) {
               ...
               RelativeLayout layout= new RelativeLayout(this);
                ...
                View view= getLayoutInflater().inflate(R.layout.list,null); //use "list" layout
                ...
                //for grey borders/lines in the list
